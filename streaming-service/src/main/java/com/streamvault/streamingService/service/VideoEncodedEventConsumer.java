...
import com.streamvault.streamingService.event.VideoEncodedEvent;
...
public class VideoEncodedEventConsumer {
    ...
    /**
     * Listens to video.encoded topic
     * Stores master playlist key in redis when encoding is completed
